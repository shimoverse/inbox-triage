...
SYSTEM = (
    ...
    "action=important for things they care about; action=not_important for things that can wait; "
    "action=junk only for things they call junk, spam or worthless and never want to see. "
